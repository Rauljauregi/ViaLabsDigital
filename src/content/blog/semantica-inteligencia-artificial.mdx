---
title: Semántica en la inteligencia artificial: word embeddings en NLP
description: "Los word embeddings revolucionan el NLP, mejorando algoritmos para traducción,
  análisis de sentimientos y más. ¡Puedes aplicarlos en tus proyectos!"
category: Deep Learning
pubDate: 2024-06-06T17:00:00.000Z
heroImage: /images/word-embeddings.jpg
tags:
...
> Ejemplo: En la imagen inferior los vectores capturar las siguientes características: *living being* (seres vivos), *feline* (si es un felino o no), *human, gender* (género), *royalty*, *verb* (si es un verbo), y si es *plural* .

![](/images/word--embeddings2.png)

La diferencia del valor numérico que hay dentro de cada celda, nos indica lo cercano en cuanto a semántica de dos palabras con relación a una dimensión o característica.

## **6. Visualización de word embeddings**

Para entender mejor los *word embeddings*, podemos visualizarlos en un espacio de baja dimensión utilizando técnicas como t-SNE o PCA, no nos vamos a meter en el beringenal de explicar eso. Pero lógicamente como humanos no podemos entender un espacio de 1024 dimensiones o más. Y esta reducción nos permite ver cómo se agrupan palabras similares y cómo se separan palabras diferentes 🧩.

> Ejemplo: Visualizar las relaciones entre palabras de un tema específico en un gráfico puede ayudarte a identificar agrupaciones y conexiones relevantes. en la imagen vemos un gráfico para la relación \*Male-Female\* (genero). Otro para *Verb Tense* (tiempo verbal). Y \*Country-Capital (país y capital).

![](/images/word-embeddings3.jpg)

Como puedes ver de esta forma es más sencillo entender que la dirección vectorial nos permite partiendo de una palabra king obtener queen , simplemente por comparación con el vector man-woman. Esta aproximación ya te darás cuenta las puertas tan grandes que abre, se puede decir que las máquinas entienden la semántica y el contendio de esta forma.
...
Espero que este artículo te haya servido para entender lo que a diario nos bombaerdean los medios de comunicación con noticias impresionantes en este campo. Puede que se te ocurra cómo podrías utilizar esta técnica para mejorar tu negocio. ¿Tienes alguna idea en mente donde podrías aplicarlos?¡Cuéntamelo!
