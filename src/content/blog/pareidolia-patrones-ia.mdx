...
<figure class="my-10 text-center">
  <img
    src="/images/pareidolia-cara-marte.jpg"
    alt="La famosa 'cara de Marte': a la izquierda la imagen original de baja resolución de la sonda Viking y a la derecha una imagen posterior de mayor resolución que muestra la formación rocosa real"
...
En esencia, el modelo intenta adivinar cuál es la siguiente palabra más probable basándose en los patrones que ha aprendido en millones de textos.
