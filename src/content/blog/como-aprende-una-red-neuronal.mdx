...
Al final hemos visto **cómo se entrena una red neuronal**, tanto en la **teoría matemática** como en la **práctica de negocio**.

Hemos implementado un **aprendizaje supervisado**  
