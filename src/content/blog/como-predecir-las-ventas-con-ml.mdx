...
description: >-
    Cómo predecir pedidos problemáticos en empresas de miniaturas coleccionables con Machine Learning. Aprende a usar XGBoost y SHAP para optimizar tus operaciones y mejorar la satisfacción del cliente. ¡Mejora la logística de tu negocio con datos!
...
<a href="https://colab.research.google.com/drive/1WWjMnQMs91CdpV9MN69A2yuHY38Eqn51" target="_blank" rel="noopener">👉 Abrir el notebook aquí</a>
...
### **5. Gráfico de ventas históricas y predicciones futuras**

En lugar de comparar únicamente valores reales y predichos, mostramos un gráfico que combina las ventas históricas con las proyecciones futuras generadas por el modelo.

1. **Línea de ventas históricas:** Muestra los datos reales de ventas en función del tiempo.
2. **Línea de predicciones futuras:** Muestra las ventas previstas para periodos futuros (próximos meses), basándose en las tendencias aprendidas por el modelo.

Este gráfico es mucho más intuitivo, ya que permite visualizar cómo el modelo proyecta las ventas para periodos que no están en el dataset original.

Por ejemplo, si observas un aumento en los meses futuros, significa que el modelo está anticipando un crecimiento basado en patrones históricos.

![Gráfico de ventas temporales](/images/ventas-historicas-futuras.png)
...
👉 <a href="https://vialabsdigital.com" title="Consultoría de Machine Learning para empresas" alt="ViaLabs Digital"  target="_blank" rel="noopener">ViaLabs Digital</a>.
