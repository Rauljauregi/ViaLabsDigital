...
pubDate: 2025-11-07T15:00:00.000Z
...
\[
x \text{ es la representación de entrada (por ejemplo, embeddings de palabras).}
\]

\[
W_q, W_k, W_v \text{ son matrices de pesos aprendibles que proyectan la entrada en los espacios de query, key y value.}
\]
