...
heroImage: /public/images/eventos-Google-OpenAI.webp
tags:
...
Una vez más es viernes, y eso significa que es momento para nuestra dosis semanal de **Inteligencia Artificial**. Hoy, te iba a contar sobre un proyecto *RAG* super interesante en el que estoy trabajando con uno de mis mejores clientes (es una maravilla trabajar con ellos, ¡Qué suerte tengo!), pero la actualidad nos desborda. Y he tenido que cambiar de tema ya que esta semana han sido los eventos más importantes del año de dos gigantes en el campo de la **IA**, *Google I/O 2024* y el *OpenAI Spring Update*. Y claro, hay que comentarlos... Prepárate, porque las cosas están a punto de ponerse interesantes.
...
![](/public/images/images/openai-google.webp)
