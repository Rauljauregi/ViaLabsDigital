...
La atención ([*Multi-Head Attention*](https://www.elladodelmal.com/2024/01/attention-is-all-you-need-la_01380413382.html#:~:text=Multi%2DHead%20Attention%20(Atenci%C3%B3n%20de,cada%20'cabeza'%20de%20atenci%C3%B3n.){:target="_blank"})) permite que el modelo enfoque su "atención" en las palabras más importantes para cada contexto. Por ejemplo, en la frase:  
