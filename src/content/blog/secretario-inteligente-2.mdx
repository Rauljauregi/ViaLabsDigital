...
Un agente no es un programa que ejecuta tareas fijas. Es un sistema que actúa en tu nombre dentro de un entorno cambiante. Según Andre Ng, un agente real debe tener:
