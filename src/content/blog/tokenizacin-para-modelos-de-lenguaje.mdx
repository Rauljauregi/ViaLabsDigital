...
> La frase "Today is a beautiful day outside."
> Tokenización:
...
> Cada token se convierte en un identificador único basado en un vocabulario predefinido: \[98, 1452, 43, 15, 2932, 1709, 740, 1452, 3112, 3823, 74].
...
La tokenización y los *embeddings* trabajan juntos para transformar texto en datos que los modelos de lenguaje pueden interpretar y manipular eficazmente. Recuerda:
