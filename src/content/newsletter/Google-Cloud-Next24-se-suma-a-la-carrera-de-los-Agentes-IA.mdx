...
[https://www.youtube.com/watch?v=V6DJYGn2SFk\&t=4s](https://www.youtube.com/watch?v=V6DJYGn2SFk\&t=4s)

Al hilo de esto, y como ya te he ido comentando útimamente he estado metido en aprender e incluso pilotar un poco sobre los Agentes IA. Es una tendencia demasiado grande para ignorarla. Y esta semana he avanzado bastante con esto.
...
Es por esto que la creación de agentes en local me ha tenido absorto gran parte de esta semana. He aprendido bastante, y aunque realizar Agente IA usando la API de OpenAI, Gemini, Claude mistral etc, facilita esta labor. Al final el problema de los datos es el mismo. Crear un agente con los modelos de lenguaje open source actuales puede llegar a dar mejores resultados incluso que modelos más avanzado. Y no es sólo una cuestión de precio (los open source son gratuitos y el uso de APIs tiene coste).

Bueno sin más me despido hasta la semana que viene, que quien sabe que nuevas novedades nos llegarán en este mundo tan cambiante del machine learning.
