...
![sesgo y Varianza en Machine Learning](/src/assets/Bias-variance-trade-off-in-machine-learning-This-figure-illustrates-the-trade-off.png)

En el eje horizontal, tenemos la complejidad del modelo, que aumenta de izquierda a derecha.

En el eje vertical, el error de predicción.

Una curva ascendente representa la varianza: a medida que el modelo se vuelve más complejo, su varianza aumenta.

Una curva descendente representa el sesgo: a medida que aumentamos la complejidad, el sesgo disminuye.

El punto donde estas curvas se cruzan representa el equilibrio óptimo entre sesgo y varianza.
...
Hasta la próxima semana, donde continuaremos desentrañando los misterios del machine learning y sus aplicaciones prácticas.
