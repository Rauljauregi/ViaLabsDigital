...
description: "Más sobre la compleja relación entre explicabilidad e interpretabilidad en IA. El reto de equilibrar precisión, equidad y comprensión en modelos de machine learning con un enfoque un poco técnico.  \U0001F916\U0001F9E0\U0001F4A1 #MachineLearning #IAExplicable #Interpretabilidad"
category: Deep Learning
pubDate: 2024-02-22T23:00:00.000Z
heroImage: /public/images/src/assets/interpretabilidad-explicabilidad-2.webp
tags:
...
La interpretabilidad en el aprendizaje automático se refiere a qué tan bien podemos entender cómo un modelo llega a sus decisiones. Tomemos, por ejemplo, un modelo simple de regresión logística, el cual podría usar cinco variables de entrada. Cada una de estas variables es multiplicada por un coeficiente específico (conocido como "peso") ![](/public/images/src/assets/wi.png)y luego se suma un valor constante (el "sesgo" o "intercepto") ![](/public/images/src/assets/b.png)para obtener la predicción final. En términos más simples, la fórmula que usamos es algo así como "suma ponderada de las variables más un valor constante". Esto se ve matemáticamente como

![](/public/images/src/assets/regresión.png)
